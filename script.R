...
plot(engQuarries$geometry)
tileInters <- 
  st_intersects(st_transform(grid5k,27700),coorSf)
tileIntersClean <- 
  tileInters[unlist(lapply(tileInters, function(x) length(x) > 0))]
